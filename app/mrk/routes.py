...
from app.mrk.gtm_spy.index import (skip_macro_keys, macros_index, skip_tag_keys,
                                   code_snippet_properties, triggers_index, skip_groups)
...
def gtm_intel_triggers():
    ...
    return render_template('mrk/gtm_spy/triggers.html', model_gtm_path=container_url,
                           ...
                           triggers_index=triggers_index, predicates=predicates, type_check=type_check, get_macro=get_macro,
                           process_mapping=process_mapping, macros_index=macro_index, variables=variables,
                           skip_tag_keys=skip_keys_tags)
